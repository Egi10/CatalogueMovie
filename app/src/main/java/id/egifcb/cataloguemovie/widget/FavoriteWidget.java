...
public class FavoriteWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "id.egifcb.cataloguemovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "id.egifcb.cataloguemovie.EXTRA_ITEM";
